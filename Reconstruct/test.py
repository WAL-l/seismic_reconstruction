...
def main(conf: conf_mgt.Default_Conf):
    ...
    for batch in iter(dl):
        ...
        # n_d=(result.get('gt') * model_kwargs.get('gt_keep_mask') + result['sample']* (1 - model_kwargs.get('gt_keep_mask')))*gyuiyi
...
if __name__ == "__main__":
    ...
    parser.add_argument('--conf_path', type=str, required=False, default="confs/example.yml")
